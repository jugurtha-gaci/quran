...
@section('content')
    ...
    <div class="bg-light py-5 checkout">
        <div class="container">
            <a href="{{ route("dashboard") }}"><i class="fas fa-angle-left"></i> Back</a>
            <h1 class="py-5 special-heading text-center" style="font-size: 35px">Paye <span>{{ $price }}$</span> to renew your subscription</span></h1>
            ...
            <div class="row justify-content-center">
                <div class="col-md-7">
                    <form action="{{ route('renew.card') }}" method="POST" class="mt-4 active" id="paywith-card">
                        @csrf
                    ...
                    <form action="{{ route("renew.paypal") }} method="POST" class="mt-4" id="paywith-paypal">
                        @csrf
